      ...
      <div className="container">
        <div class="wpb_wrapper">
          ...
          <p class="p2">
            ...
            Policy explains the type of information collected from you, how the
            information is used and under what circumstances we may disclose the
            information to third parties. You should take note that this Privacy
            Policy can only be applied on information collected by us via our
            website and cannot be applied to information collected from other
            sources.
          </p>
          <p class="p2">
            <b>1. Website Users </b>
          ...
          <p class="p2">
            ...
            information that is made available by servers and web browsers. This
            general information is such as date and time of each user request,
            type of browser, referring site and language preference. Our sole
            reason for collecting non-personally identifying information is to
            ensure we understand our users better.
          </p>
          <p class="p2">
            We collect other types of personally identifying information such as
            Internet Protocol (IP) for users who log in to our site. We only
            disclose log in information and IP addresses as per the guidelines
          ...
          <p class="p2">We collect your personal data in the following ways:</p>
          <ul class="ul1">
            <li class="li6">
              <span class="s1">When you sign up </span>– when you sign up, we
              collect certain personal data, so you can use our website such as
              your email address and name.
            </li>
            <li class="li6">
              <span class="s1">Through your use of our website</span>– when you
              use our website, we collect personal data about your use of our
              website, such as what keywords you are tracking.
            </li>
            <li class="li6">
              <span class="s1">
              ...
              &nbsp;– from time to time, you also may provide us with additional
              personal data or give us your permission to collect additional
              personal data e.g. to provide you with more features or
              functionality. You always will have the option to change your mind
              and withdraw your consent at any time.
            </li>
            <li class="li6">
              <span class="s1">From third parties</span>&nbsp;– we will receive
              personal data about you and your activity from third parties,
              including advertisers and partners we work with in order to
              provide you with the use of our services.
            </li>
          </ul>
          <p class="p6">
          ...
          <p class="p6">
            ...
            computers/servers in which we store personal information are kept in
            a secure environment. We continually review all such measures and
          ...
          <p class="p9">
            ...
            to time. You are bound by any such revisions and should therefore
            periodically visit our website to review the then current Privacy
          ...
          <p class="p9">
            ...
            to <a href="/contact-us">contact us</a> page and fill out a form. We
            will respond to your request within 3-4 days and will proceed with
            the deletion of your data in accordance with applicable laws and
            regulations.
          </p>
        </div>
      </div>
