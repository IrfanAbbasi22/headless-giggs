...
import { cartDetails, loadCartFromWoo, cartCountries } from '../store/slices/cartSlice';
        ...
        <form onSubmit={handleSubmit}>
            <div className="flex flex-wrap gap-x-6">
                ...
                <div className="form-group w-full md:w-[calc(50%-12px)] flex flex-col gap-2 pb-8 relative">
                    ...
                    <input
                        className="py-[10px] px-4 border border-[#d9d9d9] rounded-md outline-none transition-all focus:border-primary"
                        type="text"
                        name="last_name"
