...
const Orders = () => {
  ...
  return (
    <div className="">
      <div className="flex flex-col gap-3 px-5 lg:pr-0 pb-4  ">
        <div className="  flex justify-between  items-center pt-2 lg:pt-0 ">
          ...
          <div className="font-medium text-xl hidden lg:block">
            {filterStatus === "all"
              ? "Showing All Orders"
              : `Showing ${
          ...
          <button
            onClick={openFilter}
            className=" flex items-center gap-1 bg-primary border text-white cursor-pointer py-1 px-4 rounded-lg"
          >
            ...
            <div className=" flex flex-col w-[90%]  lg:max-w-[500px]   p-5     my-2  md:my-6 rounded-md gap-5 md:gap-10   lg:top-44  absolute  bg-white  overflow-y-auto  max-h-screen">
              ...
              <div>
                <ul className="flex flex-col gap-2 lg:gap-3  pl-2">
                  {["all", "processing", "completed", "failed", "refunded"].map(
                    (status) => (
                      <li
                        key={status}
                  ...
                  <div className="flex flex-col gap-3 h-full">
                    <div className="flex flex-col gap-[6px]">
                      <div className="flex justify-between">
                        <h6 className="font-medium text-base">Delivery</h6>
                        <span
